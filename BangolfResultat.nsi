...
Section "MainSection" SEC01
  ...
  File "${PRODUCT_WORKSPACE}\BangolfResultat\doc\bilder\snittclub.gif"
  ...
  File "${PRODUCT_WORKSPACE}\BangolfResultat\doc\bilder\tabtitle.gif"
  ...
  File "${PRODUCT_WORKSPACE}\BangolfResultat\installer\data\datastore"
